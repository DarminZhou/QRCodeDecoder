package com.example.hunter.myapplication;

import com.example.hunter.myapplication.util.DebugCanvas;
import com.example.hunter.myapplication.util.DebugCanvasAdapter;
import com.example.hunter.myapplication.util.DecodingFailedException;
import com.example.hunter.myapplication.util.InvalidDataBlockException;
import com.example.hunter.myapplication.util.Point;
import com.example.hunter.myapplication.util.QRCodeDataBlockReader;
import com.example.hunter.myapplication.util.QRCodeImage;
import com.example.hunter.myapplication.util.QRCodeImageReader;
import com.example.hunter.myapplication.util.QRCodeSymbol;
import com.example.hunter.myapplication.util.RsDecode;
import com.example.hunter.myapplication.util.SymbolNotFoundException;
import com.example.hunter.myapplication.util.SystemUiHider;
 ...
 * @see SystemUiHider
 */
public class QRCodeDecoder extends Activity {
    int numTryDecode;
